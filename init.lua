...
-- Map jj to escape to normal mode from insert mode
vim.keymap.set('i', 'jj', '<Esc>', { noremap = true, silent = true })

-- Install nvim-treesitter if you don't have it
-- Add this to your plugin manager section

-- Treesitter configuration
require'nvim-treesitter.configs'.setup {
  -- Install parsers for C, C++, and CUDA
...
-- Add this if using a plugin manager like lazy.nvim
return {
  {
